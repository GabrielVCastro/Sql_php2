...
INSERT INTO `admim` (`id`, `nome`, `email`, `senha`, `cpf`) VALUES
	(1, 'Administrador', 'adm@teste.com', '4f22a5b713259a8b3e6d47c9073d7eef25e6ced4c20cbe49abaaa2e80b01e4e37c1a7c16891810668dd9a6bd88f259bbf8b7a672d37e785c3f2f3aa0b7169b54', '12356978954');
/*!40000 ALTER TABLE `admim` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_2.chamado
CREATE TABLE IF NOT EXISTS `chamado` (
  ...
  CONSTRAINT `chamado_ibfk_1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela sql_2.chamado: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `chamado` DISABLE KEYS */;
/*!40000 ALTER TABLE `chamado` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_2.cidade
...
-- Copiando dados para a tabela sql_2.cidade: ~5.564 rows (aproximadamente)
...
-- Copiando estrutura para tabela sql_2.comentario
CREATE TABLE IF NOT EXISTS `comentario` (
  ...
  CONSTRAINT `comentario_ibfk_1` FOREIGN KEY (`id_chamado`) REFERENCES `chamado` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela sql_2.comentario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `comentario` DISABLE KEYS */;
/*!40000 ALTER TABLE `comentario` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_2.estado
...
-- Copiando dados para a tabela sql_2.estado: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela sql_2.pais
...
-- Copiando dados para a tabela sql_2.pais: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `pessoas` (
  ...
  CONSTRAINT `pessoas_ibfk_2` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id`)
